...
#     "ft.weight": weights["ft.weight"] / QA,
#     "ft.bias": weights["ft.bias"] / QA,
    
#     # Layer 1
#     "l1.weight": weights["l1.weight"] / QA,
#     "l1.bias": weights["l1.bias"] / QA,
    
#     # Layer 2
#     "l2.weight": weights["l2.weight"] / QA,
#     "l2.bias": weights["l2.bias"] / QA,
    
#     # Output layer
#     "l3.weight": weights["l3.weight"] / QA,
#     "l3.bias": weights["l3.bias"] / QA,
# }
...
fenList = ["8/3kP3/1K4p1/8/2P2p1p/8/6PP/8 w - - 0 67"]
